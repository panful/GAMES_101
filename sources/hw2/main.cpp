...
Eigen::Matrix4f get_projection_matrix(float eye_fov, float aspect_ratio, float zNear, float zFar)
{
    ...
    double halfEyeRadian = eye_fov * std::numbers::pi / 2.0 / 180.0;
...
int main(int argc, const char** argv)
{
    ...
    std::vector<Eigen::Vector3f> pos { { 2, 0, -2 }, { 0, 2, -8 }, { -2, 0, -8 }, { 3.5, -1, -5 }, { 2.5, 1.5, -5 }, { -1, 0.5, -5 } };

    std::vector<Eigen::Vector3i> ind { { 0, 1, 2 }, { 3, 4, 5 } };

    std::vector<Eigen::Vector3f> cols { { 217.0, 238.0, 185.0 }, { 217.0, 238.0, 185.0 }, { 217.0, 238.0, 185.0 }, { 185.0, 217.0, 238.0 },
