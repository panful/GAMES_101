...
public:
    ...
    void set_pixel(const Eigen::Vector3f& point, const Eigen::Vector3f& color, float depth);
...
private:
    void draw_fill(const std::array<Eigen::Vector3f, 3>& points, const Eigen::Vector3f& color);
